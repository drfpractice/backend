"""
Django settings for lessonapp project.
...
SECRET_KEY = 'django-insecure-7@ra^mwagy73#$hoofvw8u@_mcv+=12wqt-c6jyyreou39d=ft'
...
WSGI_APPLICATION = 'lessonapp.wsgi.application'
